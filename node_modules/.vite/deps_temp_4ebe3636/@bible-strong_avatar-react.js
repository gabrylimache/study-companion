...
//#region node_modules/@bible-strong/avatar-core/dist/ambientMotion.js
var e = [
	"none",
	"microSaccades",
	"shake"
...
var c$2 = (e) => e.headX * .71 + e.headY * 1.13 + e.headZ * 1.37;
var l$2 = 17.29;
var u$2 = (e, t, n, r) => {
	let i = e / r, a = Math.floor(i), c = o$2(i - a), l = s$2(a * 3 + t + n);
	return l + (s$2((a + 1) * 3 + t + n) - l) * c;
};
var d$2 = (e, t, n) => {
	let r = 1100;
	if (e <= 0) return 0;
	let i = Math.floor(e / r), a = (e - i * r) / 140, c = o$2(Math.min(a, 1)), l = i === 0 ? 0 : s$2((i - 1) * 2 + t + n);
	return l + (s$2(i * 2 + t + n) - l) * c;
};
var m$2 = (e, t, n = 1) => {
...
var h$2 = (e, t, n = 1) => {
	let r = { ...e }, i = c$2(e);
	if (e.bodyMotion === "slowDrift") r.headX += u$2(t, 0, i, 2600) * .8 * n, r.headY += u$2(t, 1, i, 3300) * 1.15 * n, r.headZ += u$2(t, 2, i, 4100) * .45 * n;
...
var g$3 = (e, t, n = 1) => {
	let r = h$2(e, t, n), i = m$2(e, t, n);
	return r.positionXLeft += i.x, r.positionXRight += i.x, r.positionYLeft += i.y, r.positionYRight += i.y, r;
};
//#endregion
//#region node_modules/@bible-strong/avatar-core/dist/surfaces.js
var n = (e, t) => Math.sign(e) * Math.abs(e) ** t;
var r = (e, t, r, i, a, o, s) => {
...
var a$1 = (e) => Math.max(0, Math.min(2, e ?? 0));
var o$1 = (e) => 1 + a$1(e.roundness) / 2;
var s$1 = .04;
var c$1 = (e) => e.roundness <= 0 ? Infinity : 2 / (s$1 + a$1(e.roundness) / 2 * .96);
var l$1 = (e, t, n, r) => {
...
var u$1 = (e, t, n) => l$1(e, t, n, o$1(e));
var d$1 = (e, t, n) => l$1(e, t, n, c$1(e));
var f$2 = .24;
var p$2 = .2;
var m$1 = .22;
var h$1 = (e) => a$1(e.morphRoundness) / 2;
var g$2 = (e, t, n) => {
	let r = h$1(e), i = Math.max(0, Math.min(1, t)), a = Math.sin(i * Math.PI), o = (1 - Math.cos(i * Math.PI)) / 2;
	return {
...
var v$1 = (e) => ({
	tipFraction: (e.tipRoundness ?? 0) * f$2,
	baseFraction: (e.baseRoundness ?? 0) * p$2
});
var y$2 = (e, t) => {
	let n = Math.max(0, Math.min(1, t)), r = e.roundness * m$1;
	if (r <= 0) return {
		radiusScale: 1,
...
var S$1 = (e, t) => {
	let n = Math.max(0, Math.min(1, t)), { tipFraction: r, baseFraction: i } = v$1(e);
	if (i > 0 && n < i) {
		let e = n / i;
		return {
			radiusScale: _$1(1 - i, 1, 1 - i / 2, 1 - i, e),
			verticalProgress: _$1(0, 0, i / 2, i, e)
		};
	}
	if (r > 0 && n > 1 - r) {
		let e = (n - (1 - r)) / r;
		return {
			radiusScale: _$1(r, r / 2, r / 4, 0, e),
			verticalProgress: _$1(1 - r, 1 - r / 2, 1, 1, e)
		};
	}
	return {
		radiusScale: 1 - n,
...
var T$1 = (e, t, n) => {
	...
	switch (e.type) {
		...
		case "cube": return d$1(e, t, n);
		case "cylinder": {
			let r = b$2(e, (n + Math.PI / 2) / Math.PI);
			return [
		...
		case "cursor": {
			let r = w$1(e), i = (n + Math.PI / 2) / Math.PI, a = y$2({
				...e,
				width: r.bodyWidth,
				height: r.bodyHeight,
				depth: r.bodyDepth
		...
		case "diamond": return u$1(e, t, n);
		case "capsule": return i(e, t, n);
		case "cone": {
			let r = C$1(e, (n + Math.PI / 2) / Math.PI);
			return [
				a / 2 * r.radiusScale * Math.sin(t),
				o / 2 - o * r.verticalProgress,
				s / 2 * r.radiusScale * Math.cos(t)
...
var k$3 = (e, t, n) => {
	...
	let i = T$1(e, t - r, n), a = T$1(e, t + r, n), o = T$1(e, t, Math.max(-Math.PI / 2, n - r)), s = T$1(e, t, Math.min(Math.PI / 2, n + r));
	return O$3(e, E$1(a, i), E$1(s, o));
};
var A$2 = (e, t) => Math.sign(e) * Math.abs(e) ** t;
var j$2 = (e, t, n) => {
...
var M$2 = (e, t) => j$2(e, t, o$1(e));
var N$1 = (e, t) => {
	let n = c$1(e);
	if (Number.isFinite(n)) return j$2(e, t, n);
	let r = [
		t[0] / (e.width / 2 || 1),
		t[1] / (e.height / 2 || 1),
		t[2] / (e.depth / 2 || 1)
...
var I$2 = (e, t, n, r, i) => {
	let a = e.width / 2 || 1, o = e.depth / 2 || 1, s = Math.max(0, Math.min(1, .5 + i * (n / e.height))), c = x$2(e, s, r), l = a * c, u = o * c, d = Math.max(-l, Math.min(l, t)), f = l > 0 ? Math.max(0, 1 - (d / l) ** 2) : 0, p = u * Math.sqrt(f), m = 1e-4, h = Math.max(0, s - m), g = Math.min(1, s + m), _ = x$2(e, h, r), v = (x$2(e, g, r) - _) / (g - h || 1), y = Math.max(Math.sqrt(f), 1e-4), b = -(o / a) * d / (l * y || 1), S = i * o * v / (e.height * y || 1);
	return {
		point: [
			d,
			n,
...
var L$2 = (e, t, n) => {
	...
	switch (e.type) {
		case "sphere":
		case "mickey": return F$2(t, n, r, i, a);
		case "cube": return P$1(e, t, n, c$1(e), N$1);
		case "capsule": {
			let e = Math.min(r, i), o = Math.max(0, i - e);
			return F$2(t, n, r, e, a, n < -o ? -o : n > o ? o : n);
		}
		case "cylinder": return I$2(e, t, n, b$2, 1);
		case "cursor": {
			let r = w$1(e), i = I$2({
				...e,
				width: r.bodyWidth,
		...
		case "cone": return I$2(e, t, n, C$1, -1);
		case "diamond": return P$1(e, t, n, o$1(e), M$2);
	}
};
var z$2 = (e, t, n) => {
	let r = T$1(e, t, n);
...
//#endregion
//#region node_modules/@bible-strong/avatar-core/dist/geometry.js
var a = 620;
var o = 14;
var s = [
	"headX",
...
var D$1 = (e, t = !0) => e.length ? `M${e[0][0].toFixed(2)} ${e[0][1].toFixed(2)}${e.slice(1).map((e) => `L${e[0].toFixed(2)} ${e[1].toFixed(2)}`).join("")}${t ? "Z" : ""}` : "";
var O$2 = (e) => ({
	expression: e,
	orientation: p$1(l(e.headX), l(e.headY), l(e.headZ))
});
var ae = (e, t, n) => {
	let r = { ...e.expression };
	return s.forEach((i) => {
		let a = t.expression[i];
		(i === "headX" || i === "headY" || i === "headZ" || i === "leftAngle" || i === "rightAngle") && (a = g$1(a, e.expression[i])), r[i] = e.expression[i] + (a - e.expression[i]) * n;
	}), {
		expression: r,
		orientation: O$2(r).orientation
	};
};
var oe = 24;
var se = 25;
...
var P = (e, t, n) => (e.size >= oe && e.delete(e.keys().next().value), e.set(t, n), n);
var F$1 = (e, t, n) => z$2(e, t, n);
var I$1 = (e, t) => ({
	point: x$1(y$1(e.orientation, t.point), e.expression.perspective),
	normal: y$1(e.orientation, t.normal)
});
var de = (e, t) => {
	let n = e / 120, r = t / 120;
...
var z$1 = (e) => {
	...
	}), n.length && t.push(n), t.filter((e) => e.length > 1).map((e) => D$1(e, !1)).join("");
};
var B$1 = (e, t) => {
	let n = N(t), r = M$1.get(n);
	if (!r) {
		let e = [
			-60,
			-30,
			...
			30,
			60
		].map((e) => Array.from({ length: 73 }, (n, r) => F$1(t, l(-180 + r * 5), l(e)))), i = Array.from({ length: 12 }, (e, t) => -150 + t * 30).map((e) => Array.from({ length: 37 }, (n, r) => F$1(t, l(e), l(-90 + r * 5))));
		r = P(M$1, n, [...e, ...i]);
	}
	return r.map((t) => z$1(t.map((t) => I$1(e, t))));
};
var U$1 = (e) => {
...
var fe = (e) => e.length ? e.length === 1 ? `${e[0][0].toFixed(2)} ${e[0][1].toFixed(2)}` : e.slice(0, -1).map((t, n) => {
...
var K$1 = (e, t) => x$1(y$1(e.orientation, t), e.expression.perspective);
var q$1 = (e, t, n) => Array.from({ length: 145 }, (r, i) => {
	let a = i / k$2 * Math.PI * 2;
	return [
		e / 2 * Math.sin(a),
		n,
		t / 2 * Math.cos(a)
...
var J$1 = (e, t) => {
	let r = N(t), i = A$1.get(r);
	return i || (i = Array.from({ length: le }, (e, r) => {
		let i = -Math.PI / 2 + r / 32 * Math.PI;
		return Array.from({ length: ue }, (e, r) => {
			return T$1(t, -Math.PI + r / 72 * Math.PI * 2, i);
		});
	}).flat(), P(A$1, r, i)), W$1(G$1(U$1(i.map((t) => K$1(e, t)))));
};
var pe = (e, t) => {
	if (t.roundness > 0 || (t.morphRoundness ?? 0) > 0) return J$1(e, t);
	let n = t.height / 2;
	return W$1(G$1(U$1([...q$1(t.width, t.depth, -n), ...q$1(t.width, t.depth, n)].map((t) => K$1(e, t)))));
};
var me = (t, n) => {
	let r = w$1(n), i = r.bodyHeight / 2;
	return W$1(G$1(U$1([...q$1(r.bodyWidth, r.bodyDepth, r.bodyCenterY - i), ...q$1(r.bodyWidth, r.bodyDepth, r.bodyCenterY + i)].map((e) => K$1(t, e)))));
};
var he = (t, n) => {
	let r = w$1(n), i = K$1(t, [
		0,
	...
	return W$1(G$1(U$1([...q$1(n.width, n.depth, r.coneBaseY).map((e) => K$1(t, e)), i])));
};
var ge = (e, t) => {
	if ((t.morphRoundness ?? 0) > 0 || (t.tipRoundness ?? 0) > 0 || (t.baseRoundness ?? 0) > 0) return J$1(e, t);
	let n = K$1(e, [
		0,
		-t.height / 2,
		0
	]), r = U$1([...q$1(t.width, t.depth, t.height / 2).map((t) => K$1(e, t)), n]), i = r.findIndex((e) => Math.hypot(e[0] - n[0], e[1] - n[1]) < .01);
	if (i < 0) return W$1(r);
	let a = [...r.slice(i), ...r.slice(0, i)].slice(1);
	return a.length < 2 ? D$1(r) : `M${n[0].toFixed(2)} ${n[1].toFixed(2)}L${a[0][0].toFixed(2)} ${a[0][1].toFixed(2)}${fe(a)}L${n[0].toFixed(2)} ${n[1].toFixed(2)}Z`;
};
var _e = (e, t) => {
	if (t.roundness > 0) return J$1(e, t);
	let n = t.width / 2, r = t.height / 2, i = t.depth / 2;
	return D$1(U$1([-1, 1].flatMap((e) => [-1, 1].flatMap((t) => [-1, 1].map((a) => [
		e * n,
		t * r,
		a * i
	]))).map((t) => K$1(e, t))));
...
var X$1 = ({ centerX: e, centerY: t, majorRadius: n, minorRadius: r, rotation: i }) => {
...
var Z$1 = (e, t, n = [
	...
	return C <= 0 ? null : Y$1(g, _, S / C, -x / C, b / C);
};
var ye = (e, t) => {
	let n = Z$1(e, [
		t.width / 2,
...
var be = (e, t) => {
	...
	return [-1, 1].map((t) => Z$1(e, s, [
		t * i,
		a,
		o
	])).filter((e) => e !== null).map(X$1);
};
var xe$1 = (e, t) => t.type === "mickey" ? be(e, t) : t.type === "cursor" ? [he(e, t)] : [];
var Q$1 = (e) => Array.from({ length: k$2 }, (t, n) => {
	let r = n / k$2 * Math.PI * 2, i = Math.cos(r) * e.majorRadius, a = Math.sin(r) * e.minorRadius;
	return [
...
var Ce$1 = (e, t) => {
	...
	return !s || !c ? null : Se$1(U$1([...Q$1(s), ...Q$1(c)]));
};
var $$1 = (e, t) => {
	...
	}).flat(), P(A$1, r, i)), D$1(U$1(i.map((t) => x$1(y$1(e.orientation, t), e.expression.perspective))));
};
var we$1 = (e, t) => {
	let r = N(t.surface), i = j$1.get(r);
	i || (i = Array.from({ length: 17 }, (e, r) => {
		let i = -Math.PI / 2 + r / 16 * Math.PI;
		return Array.from({ length: 49 }, (e, r) => {
			let a = -Math.PI + r / 48 * Math.PI * 2;
			return T$1(t.surface, a, i);
		});
	}).flat(), P(j$1, r, i));
	let a = p$1(l(t.rotation[0]), l(t.rotation[1]), l(t.rotation[2])), o = U$1(i.map((n) => {
		let r = y$1(a, n), i = [
			r[0] + t.position[0],
			r[1] + t.position[1],
			r[2] + t.position[2]
		];
		return x$1(y$1(e.orientation, i), e.expression.perspective);
	}));
	return (t.surface.type === "cube" || t.surface.type === "diamond") && t.surface.roundness <= 0 ? D$1(o) : W$1(G$1(o));
};
var Te$1 = .1;
var Ee = (e, t) => {
	let n = p$1(l(t.rotation[0]), l(t.rotation[1]), l(t.rotation[2])), r = [
		[
			1,
			0,
			0
...
var Oe = (e, t, n = 1, r = {}) => {
	let i = R(e, t, -1, n, r.eyeOffset), a = R(e, t, 1, n, r.eyeOffset), o = i.map((e) => e.point), s = a.map((e) => e.point), c = De(e, r.bodyNodes ?? []), l = xe$1(e, t);
	return {
		...
		wirePaths: r.includeWire === !1 ? [] : B$1(e, t)
	};
};
//#endregion
...
var F = new (/* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var I = (e) => e.replaceAll("~", "~0").replaceAll("/", "~1");
var L = (e, t) => `${e}/${I(String(t))}`;
var xe = (e) => {
...
var Se = (e) => e.instancePath === "/schemaVersion" && e.keyword === "const" ? "unsupported_version" : e.keyword;
var Ce = (e) => (e ?? []).map((e) => ({
	path: xe(e),
	code: Se(e),
...
var W = (e, t, n = {}, r = 1) => {
	let i = U(e.body);
	return {
		geometry: Oe(O$2(t), i.primary, r, { bodyNodes: i.nodes }),
		colors: {
...
var $ = (e, t, n, r) => {
	...
	if (t.directTransition && !r.reduceMotion) {
		...
		o = ae(O$2(t.directTransition.from.expression), O$2(o), e).expression, s = Z(t.directTransition.from.colors, s, e);
		...
		if (n.ok) {
			...
			if (t.phase === "transition" && a && !r.reduceMotion) {
				...
				if (r && c) {
					...
					o = ae(O$2(r), O$2(o), n).expression, s = Z(c, s, n);
				}
			}
			c = Q(n.value, t, i);
		}
...
var Fe = (e, t, n, i) => {
	let a = $(e, t, n, i);
	return W(e, i.reduceMotion ? a.expression : g$3(a.expression, a.sampledAt), a.colors, a.blink);
};
//#endregion
//#region node_modules/@bible-strong/avatar-react/dist/index.js
...
var O = (e, t, r, i, a) => {
	...
	let l = r ?? (t === void 0 ? a : void 0) ?? "neutral", u = Ae(e, l);
	return {
		...K(),
		activeExpression: u.ok ? l : "neutral"
	};
};
function k({ definition: e, ref: d, animation: b, expression: w, defaultAnimation: k, defaultExpression: A, autoplay: j, size: M = 240, className: ee, style: te, ariaLabel: ne = "Procedural avatar", onError: N, onAnimationEnd: P, onExpressionChange: F }) {
	D({
		animation: b,
		expression: w,
		defaultAnimation: k,
	...
	let I = `${(0, import_react.useId)().replaceAll(":", "")}-head`, L = (0, import_react.useRef)(null), R = (0, import_react.useRef)(null), z = (0, import_react.useRef)(null), B = (0, import_react.useRef)(null), V = (0, import_react.useRef)([]), H = (0, import_react.useRef)([]), U = (0, import_react.useRef)(!1), W = (0, import_react.useRef)(void 0), G$2 = (0, import_react.useRef)(null), K$2 = (0, import_react.useRef)(null), q = (0, import_react.useRef)(e), [J, Y] = (0, import_react.useState)(() => O(e, b, w, k, A)), X = (e) => {
	...
	}, Z = (t, n, r) => (K$2.current = $(e, t, n, r), Fe(e, t, n, r));
	(0, import_react.useLayoutEffect)(() => {
		let e = G$2.current ?? J, t = performance.now(), n = C();
		X(Z(e, t, n));
	}), (0, import_react.useEffect)(() => {
		G$2.current = J;
	}, [J]), (0, import_react.useEffect)(() => {
		if (q.current === e) return;
		q.current = e, K$2.current = null, U.current = !1, W.current = void 0;
		let t = O(e, b, w, k, A);
		G$2.current = t, Y(t);
	}, [
		b,
		...
		if (b !== void 0 || w !== void 0) return;
		let t = k ? G(e, k) : A ? Ae(e, A) : null;
		...
		if (U.current || b !== void 0 || w !== void 0 || k === void 0 || j === !1) return;
		U.current = !0;
		let t = je(e, k, performance.now());
		t.ok && (G$2.current = t.value, Y(t.value));
	}, [
		b,
		j,
		k,
		...
		if (w !== void 0) {
			let t = Ae(e, w);
			if (t.ok) {
				let t = G$2.current ?? K(), r = performance.now(), i = K$2.current ?? $(e, t, r, C()), a = {
					...K(),
					activeExpression: w,
					...t.activeExpression === w ? {} : {
						status: "playing",
						directTransition: {
							from: i,
							startedAt: r,
		...
		if (b !== void 0) {
			let t = G$2.current ?? K(), r = performance.now(), o = je(e, b, r, K$2.current ?? $(e, t, r, C()));
			o.ok ? (G$2.current = o.value, Y(o.value)) : N ? N(o.error) : console.error(`[Avatar] ${o.error.message}`);
		}
	}, [
		b,
		e,
	...
	}, [J.activeExpression, F]), (0, import_react.useEffect)(() => {
		if (J.status !== "playing") return;
		let n = 0, r = (i) => {
			let a = G$2.current;
			if (!a) return;
			let o = C(), s = Me(e, a, i, o);
			G$2.current = s, E(a, s) || Y(s), a.status === "playing" && s.status === "stopped" && a.activeAnimation && W.current !== a.activeAnimation && (W.current = a.activeAnimation, P?.(a.activeAnimation));
			let c = Z(s, i, o);
			X(c), s.status === "playing" && (n = requestAnimationFrame(r));
		};
	...
	(0, import_react.useImperativeHandle)(d, () => ({
		play(t) {
			...
			if (r.status === "paused" && r.activeAnimation === t && r.pausedAt !== void 0) {
				let t = Pe(r, performance.now());
				return G$2.current = t, Y(t), { ok: !0 };
			}
			let a = performance.now(), s = je(e, t, a, K$2.current ?? $(e, r, a, C()));
			return s.ok ? (W.current = void 0, G$2.current = s.value, Y(s.value), { ok: !0 }) : {
				ok: !1,
				error: s.error
			};
		},
		setExpression(t) {
			...
			let i = G$2.current ?? K(), a = performance.now(), o = K$2.current ?? $(e, i, a, C()), s = {
				...K(),
				activeExpression: t,
			...
			return G$2.current = s, Y(s), { ok: !0 };
		},
		pause() {
			let e = G$2.current;
			if (!e || e.status !== "playing") return;
			let t = Ne(e, performance.now());
			G$2.current = t, Y(t);
		},
		stop() {
			if (!Q) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: ["bs-avatar", ee ?? ""].filter(Boolean).join(" "),
		style: {
			...te,
			width: M,
			height: M
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("defs", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("clipPath", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
						ref: L,
						d: $$2.geometry.headPath
					})
				}) }),
				Array.from({ length: S }, (e, t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
					ref: (e) => {
						V.current[t] = e;
					},
					d: $$2.geometry.backPaths[t] ?? "",
					fill: $$2.colors.body
				}, `back-${t}`)),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
						ref: z,
						d: $$2.geometry.leftPath,
						opacity: +!!$$2.geometry.leftVisible
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
						ref: B,
						d: $$2.geometry.rightPath,
						opacity: +!!$$2.geometry.rightVisible
					})]
				}),
				Array.from({ length: S }, (e, t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
					ref: (e) => {
...
var j = (e) => {
	let t = (t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(k, {
		...t,
		definition: e
	});
...
function M(e) {
	let t = B(e);
	if (!t.ok) throw A(t.errors);
	return w(t.value), j(t.value);
}
//#endregion
export { k as Avatar, M as createAvatar };
